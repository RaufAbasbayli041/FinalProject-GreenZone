...
import { ArrowLeft, Edit, Calendar, User, MapPin, FileText, DollarSign } from 'lucide-react';
...
export const OrderView: React.FC = () => {
  ...
  const { data: order, isLoading } = useQuery({
    ...
    queryFn: () => adminApi.orders.getById(orderId),
    enabled: !!orderId,
  });
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => navigate(`/admin/orders/${order.id}/edit`)}>
